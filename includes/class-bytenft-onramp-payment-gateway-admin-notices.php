...
class BYTENFT_ONRAMP_PAYMENT_GATEWAY_Admin_Notices
{
	private $notices = [];

	public function bytenft_onramp_add_notice($key, $type, $message)
	{
	...
	public function bytenft_onramp_remove_notice($key)
	{
