...
define('BYTENFT_ONRAMP_PAYMENT_GATEWAY_MIN_PHP_VER', '8.0');
define('BYTENFT_ONRAMP_PAYMENT_GATEWAY_MIN_WC_VER', '6.5.4');
define('BYTENFT_ONRAMP_PAYMENT_GATEWAY_FILE', __FILE__);
define('BYTENFT_ONRAMP_PAYMENT_GATEWAY_PLUGIN_DIR', plugin_dir_path(__FILE__));

// Include utility functions
require_once BYTENFT_ONRAMP_PAYMENT_GATEWAY_PLUGIN_DIR . 'includes/bytenft-onramp-payment-gateway-utils.php';
...
spl_autoload_register(function ($class) {
	if (strpos($class, 'BYTENFT_ONRAMP_PAYMENT_GATEWAY') === 0) {
		$class_file = BYTENFT_ONRAMP_PAYMENT_GATEWAY_PLUGIN_DIR . 'includes/class-' . str_replace('_', '-', strtolower($class)) . '.php';
...
function bnftonramp_cancel_unpaid_order_action($order_id)
{
	...
	$url      = BYTENFT_ONRAMP_BASE_URL . $apiPath;
